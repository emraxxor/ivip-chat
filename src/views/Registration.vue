...
<b-container>
    ...
    <div v-if="success">
      <dialog-window title="Registration completed successfully" open='true' :data="{}" @validate="handleDialog" @invalidate="handleDialog">
          <div slot="dialogBody">
        ...
        <b-card-body>
                ...
                <b-form-group
                 ...
                 <b-form-group
                  ...
                  >
                    ...
                    <b-form-input placeholder="Email address" id="input-email" v-model="email" :state="validEmail" trim></b-form-input>
                </b-form-group>
                ...
                <b-form-group
                  ...
                  >
                    ...
                    <b-form-input placeholder="Confirm email address" id="input-email-confirm" v-model="emailAgain" :state="validEmail" trim></b-form-input>
                </b-form-group>
                ...
                <b-form-group
                  ...
                  >
                    ...
                    <b-form-input type="password" placeholder="Your password" id="input-password" v-model="password" :state="validPassword" trim></b-form-input>
                </b-form-group>
                 ...
                 <b-form-group
                  ...
                  >
                    ...
                    <b-form-input type="password" placeholder="Confirm your password" id="input-password-confirm" v-model="passwordConfirm" :state="validPassword" trim></b-form-input>
                </b-form-group>



                <b-button @click="registration($event)" class="primary">Registration</b-button>
                <router-link to="/"><b-button>Cancel</b-button></router-link>
